    ...
    <>
      <section className="text-gray-600 body-font">
        <div className=" w-full bg-gray-100 py-32 sm:py-80 px-10 relative mb-4">
          <img alt="gallery" className="w-full object-cover h-full object-center block absolute inset-0" src="/sources/restaurants.jpg" />
        </div>
        <div className="text-center sm:mt-20 mt-10 mb-20">
          <h1 className="sm:text-4xl text-2xl font-extrabold title-font text-gray-900 mb-4">Website templates for every cuisine</h1>
          <p className="text-xl leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">Explore Restaurants Website Templates</p>
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" className="rounded-3xl lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center " src="/Templates/feane.png" />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">

              <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">FEANE</h1>
              <p className="text-lg leading-relaxed">Introducing Feane: A sleek restaurant website template. Elevate your dining experience with our elegant design and enticing menu. Explore now!</p>
              <div className="flex mt-5">
                <Link href="https://themewagon.com/thank-you-for-downloading/?item_id=117247&dl=eHI1UE5EV1B1V3lIc0JsRHdEQ0l4WnpBUitoNUd6c1BTRG5zRlI5S0s0MXdPckhLV1NCM2dBMUVobDlsYzdSTA==" target='blank'>
                ...
                <Link href="https://themewagon.github.io/feane/" target='blank'>
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mt-6 lg:mt-0">
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">DELFOOD</h1>
              <p className="text-lg leading-relaxed">
                Delfood: Elevate your dining experience with our delectable menu and elegant ambiance. Explore our culinary delights and reserve your table today.</p>
              <div className="flex mt-5">
                <Link href="https://themewagon.com/thank-you-for-downloading/?item_id=118314&dl=eHI1UE5EV1B1V3lIc0JsRHdEQ0l4WnpBUitoNUd6c1BTRG5zRlI5S0s0MXdPckhLV1NCM2dBMUVobDlsYzdSTA==" target='blank'>
                  <button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Download</button></Link>
                <Link href="https://themewagon.github.io/delfood/" target='blank'>
                  <button className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Preview</button>
                </Link>
              </div>
            </div>
            <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded-3xl" src="/Templates/delfood.png" />
          </div>
        </div>


        <div className=" w-full bg-gray-100 py-32 sm:py-80 px-10 relative mb-4">
          <img alt="gallery" className="w-full object-cover h-full object-center block absolute inset-0" src="/sources/res2.png" />
        </div>

        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" className="rounded-3xl lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center " src="/Templates/allfood.png" />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">

              <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">ALL FOOD</h1>
              <p className="text-lg leading-relaxed">"All Food": Your ultimate destination for culinary delights. Explore our diverse menu and savor every bite. Elevate your dining experience with us</p>
              <div className="flex mt-5">
                <Link href="https://themewagon.com/thank-you-for-downloading/?item_id=101185&dl=eHI1UE5EV1B1V3lIc0JsRHdEQ0l4WnpBUitoNUd6c1BTRG5zRlI5S0s0MXdPckhLV1NCM2dBMUVobDlsYzdSTA==" target='blank'>
                  <button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Download</button></Link>
                <Link href="https://themewagon.github.io/allfood/" target='blank'>
                  <button className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Preview</button>
                </Link>
              </div>
            </div>
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mt-6 lg:mt-0">
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">FOODY</h1>
              <p className="text-lg leading-relaxed">Foody: Indulge in a culinary journey with our diverse menu and vibrant atmosphere. Experience exquisite flavors and exceptional service. Book your table now!</p>
              <div className="flex mt-5">
                <Link href="https://themewagon.com/thank-you-for-downloading/?item_id=101616&dl=eHI1UE5EV1B1V3lIc0JsRHdEQ0l4WnpBUitoNUd6c1BTRG5zRlI5S0s0MXdPckhLV1NCM2dBMUVobDlsYzdSTA==" target='blank'>
                  <button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Download</button></Link>
                <Link href="https://themewagon.github.io/foody/" target='blank'>
                  <button className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Preview</button>
                </Link>
              </div>
            </div>
            <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded-3xl" src="/Templates/foody.png" />
          </div>
        </div>
      </section>
